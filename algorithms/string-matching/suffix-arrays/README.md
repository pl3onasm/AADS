${\color{Cadetblue}\text{\huge Suffix arrays}}$
...
${\color{darkseagreen}\text{\Large Applications}}$


${\color{rosybrown}\text{\large 1. String matching}}$
...
${\color{rosybrown}\text{\large 2. Longest repeated substring}}$
...
${\color{rosybrown}\text{\large 3. Number of substrings}}$
...
${\color{rosybrown}\text{\large 4. Longest palindromic substring}}$
...
${\color{darkseagreen}\text{\Large Building the suffix array}}$
...
${\color{darkseagreen}\text{\Large Building the LCP array}}$
...
${\color{darkseagreen}\text{\Large Implementation}}$
